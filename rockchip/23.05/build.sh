...
SOFTWARE_URL="https://github.com/ForestL18/OpenWrt-nikki/releases/download/${SOFTWARE_VERSION}/nikki_aarch64_generic-openwrt-23.05.tar.gz"
#https://github.com/ForestL18/OpenWrt-nikki/releases/download/v1.21.1/nikki_aarch64_generic-openwrt-23.05.tar.gz
